...
def base_parse():
    ...
    parser.add_argument("--log_dir", type=str, default="dm_runs/")
    ...
    parser.add_argument("--project_name", type=str, default="EDM-experiments")
    parser.add_argument("--model_save_iters", type=int, default=250) 

    parser.add_argument('--chk_pt_dir', type=str, default='dm_runs/')
    parser.add_argument('--chk_pt_name', type=str,
            default='edm_hopper-medium-replay-v2_model_23-03-06-01-28-21_best.pt')
